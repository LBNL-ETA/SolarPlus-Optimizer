...
_XBOS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='BasicServerStatus', full_name='xbospb.XBOS.BasicServerStatus', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='C37DataFrame', full_name='xbospb.XBOS.C37DataFrame', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='EnergiseMessage', full_name='xbospb.XBOS.EnergiseMessage', index=12,
