...
_FLEXSTATEACTUATIONMESSAGE = _descriptor.Descriptor(
  name='FlexstateActuationMessage',
  full_name='xbospb.FlexstateActuationMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='time', full_name='xbospb.FlexstateActuationMessage.time', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='setpoints', full_name='xbospb.FlexstateActuationMessage.setpoints', index=1,
...
_FLEXSTATEACTUATIONMESSAGE.fields_by_name['setpoints'].message_type = _FLEXSTATSETPOINTS
...
DESCRIPTOR.message_types_by_name['FlexstateActuationMessage'] = _FLEXSTATEACTUATIONMESSAGE
...
FlexstateActuationMessage = _reflection.GeneratedProtocolMessageType('FlexstateActuationMessage', (_message.Message,), {
  'DESCRIPTOR' : _FLEXSTATEACTUATIONMESSAGE,
  '__module__' : 'flexstat_pb2'
  # @@protoc_insertion_point(class_scope:xbospb.FlexstateActuationMessage)
  })
_sym_db.RegisterMessage(FlexstateActuationMessage)

FlexstatSetpoints = _reflection.GeneratedProtocolMessageType('FlexstatSetpoints', (_message.Message,), {
...
FlexstatState = _reflection.GeneratedProtocolMessageType('FlexstatState', (_message.Message,), {
