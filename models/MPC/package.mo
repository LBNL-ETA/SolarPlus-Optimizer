...
package MPC "This package contains models for MPC control optimization."
  ...
  package Building "Package for building models"
    ...
    package BaseClasses
      ...
      connect(thermal.Trtu, Tzone) annotation (Line(points={{-19,20},{10,20},{10,-80},
      ...
      model Thermal
        ...
        HVAC.SimpleHeaterCooler RTU1(heatingCap=2000, coolingCap=16998)
        ...
        Modelica.Blocks.Interfaces.RealOutput Prtu "RTU power"
          annotation (Placement(transformation(extent={{100,70},{120,90}})));
        Envelope.R1C1 refZone(Tzone_0=Tref_0, R=0.1)
        ...
        Modelica.Blocks.Interfaces.RealInput uRef
          "Cooling signal input for refrigerator"
          annotation (Placement(transformation(extent={{-140,-40},{-100,0}})));
        Envelope.R1C1 freZone(Tzone_0=Tfre_0, R=0.1)
      ...
      equation
        ...
        connect(rtuZone.Tadj, Tout) annotation (Line(points={{-12,96},{-68,96},{-68,100},
                {-120,100}}, color={0,0,127}));
        ...
        connect(refZone.Tzone, Tref)
          annotation (Line(points={{61,30},{80,30},{80,40},{110,40}},
                                                      color={0,0,127}));
        connect(rtuZone.Tzone, refZone.Tadj) annotation (Line(points={{11,90},{20,90},
        ...
        connect(rtuZone.Tzone, freZone.Tadj) annotation (Line(points={{11,90},{20,90},
                {20,-24},{38,-24}}, color={0,0,127}));
