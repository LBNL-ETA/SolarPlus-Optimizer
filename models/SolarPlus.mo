      ...
      Modelica.Blocks.Interfaces.RealInput PSet
        ...
        annotation (Placement(transformation(
              extent={{-140,20},{-100,60}}), iconTransformation(extent={{-140,20},
                {-100,60}})));
    equation
      connect(Battery.SOC_meas, SOC)
        annotation (Line(points={{-19,-40},{110,-40}}, color={0,0,127}));
      connect(PSet, Battery.PSet)
      ...
      connect(weaPoaPv, pv.Iinc)
        annotation (Line(points={{-120,40},{-42,40}}, color={0,0,127}));
      connect(pv.Pgen, PPv)
        annotation (Line(points={{-18.8,40},{110,40}}, color={0,0,127}));
    annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
            Rectangle(
              extent={{-100,100},{100,-100}},
              lineColor={0,0,0},
