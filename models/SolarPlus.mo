    ...
    package BaseClasses
      ...
      block StoreIsland
        ...
        Modelica.Blocks.Math.Gain gain1(k=0)
          annotation (Placement(transformation(extent={{0,-50},{20,-30}})));
        Modelica.Blocks.Math.Gain gain2(k=0)
