...
package SolarPlus "This package contains models for MPC control optimization."
  ...
  package Building "Package for building models"
    ...
    model Whole_Inputs
      ...
      Modelica.Blocks.Math.MultiSum multiSum1(k={1,1,0,0}, nu=4)
    ...
    package Training
      ...
      model Refrigeration
        ...
        BaseClasses.Refrigeration refrigeration
          annotation (Placement(transformation(extent={{-20,0},{0,20}})));
        Modelica.Blocks.Interfaces.RealInput uRef
        ...
        Modelica.Blocks.Interfaces.RealOutput Tref(unit="K")
          "Freezer air temperature" annotation (Placement(transformation(extent={{100,
                  -10},{120,10}}), iconTransformation(extent={{100,-10},{120,10}})));
      equation
        connect(Trtu_west, refrigeration.Trtu_west) annotation (Line(points={{-120,80},
                {-60,80},{-60,17},{-21,17}}, color={0,0,127}));
        connect(Trtu_east, refrigeration.Trtu_east) annotation (Line(points={{-120,40},
                {-80,40},{-80,14},{-21,14}}, color={0,0,127}));
        connect(uFreDef, refrigeration.uFreDef) annotation (Line(points={{-120,-40},{
                -40,-40},{-40,6},{-21,6}}, color={0,0,127}));
        connect(uFreCool, refrigeration.uFreCool) annotation (Line(points={{-120,-80},
                {-30,-80},{-30,3},{-21,3}}, color={0,0,127}));
        connect(uRef, refrigeration.uRef) annotation (Line(points={{-120,0},{-60,0},{
                -60,10},{-21,10}}, color={0,0,127}));
        connect(refrigeration.Tfre, Tfre) annotation (Line(points={{1,14},{74,14},{74,
                40},{110,40}}, color={0,0,127}));
        connect(refrigeration.Tref, Tref)
          annotation (Line(points={{1,10},{30,10},{30,0},{110,0}}, color={0,0,127}));
        connect(refrigeration.Pfre, Pfre) annotation (Line(points={{1,6},{20,6},
                {20,-40},{110,-40},{110,-40}}, color={0,0,127}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
    ...
    package BaseClasses
      ...
      model Refrigeration
        ...
        parameter Modelica.SIunits.Power FreHeatingCap = 3500 "Defrost heating capacity of freezer" annotation(Dialog(group = "Freezer"));
        parameter Real FreHeatingEff = 0.99 "Heating efficiency of freezer" annotation(Dialog(group = "Freezer"));
        ...
        Modelica.Blocks.Interfaces.RealOutput Tref(unit="K")
          "Refridgerator air temperature" annotation (Placement(transformation(extent=
                 {{100,70},{120,90}}), iconTransformation(extent={{100,-10},{120,10}})));
      ...
      equation
        connect(freCooler.qHeat, freZone.qHeat)
          annotation (Line(points={{-39,-64},{-20,-64},{-20,-14},{-2,-14}},
                                                                  color={0,0,127}));
        connect(freCooler.qCool, freZone.qCool)
          annotation (Line(points={{-39,-74},{-16,-74},{-16,-18},{-2,-18}},
                                                                  color={0,0,127}));
        ...
        connect(senTref.T, Tfre) annotation (Line(points={{80,-10},{110,-10}},
                      color={0,0,127}));
        connect(freCooler.PCool, Pfre) annotation (Line(points={{-39,-78},{-12,-78},{-12,
                -60},{110,-60}},
                            color={0,0,127}));
        connect(Trtu_east, preTrtu_east.T) annotation (Line(points={{-120,40},{-92,40},
                {-92,-30},{-62,-30}},
                                    color={0,0,127}));
        connect(preTrtu_east.port, freZone.port_adj) annotation (Line(points={{-40,-30},
                {-28,-30},{-28,-4},{0,-4}},color={191,0,0}));
        ...
        connect(uHeat.y, refCooler.uHeat) annotation (Line(points={{-73,60},{-68,60},{
                -68,38},{-62,38}}, color={0,0,127}));
        connect(uRef, refCooler.uCool) annotation (Line(points={{-120,0},{-76,0},{-76,
                22},{-62,22}}, color={0,0,127}));
        connect(refCooler.qHeat, refZone.qHeat) annotation (Line(points={{-39,36},{-26,
                36},{-26,76},{-2,76}}, color={0,0,127}));
        connect(refCooler.qCool, refZone.qCool) annotation (Line(points={{-39,26},{-14,
                26},{-14,72},{-2,72}}, color={0,0,127}));
        connect(refZone.port_cap, senTref1.port)
          annotation (Line(points={{10.2,80},{66,80}}, color={191,0,0}));
        annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Rectangle(
                extent={{-100,100},{100,-100}},
                lineColor={0,0,0},
