...
import numpy as np
import mpc_config_xbos
import pandas as pd

config = mpc_config_xbos.get_config()

class unit(unittest.TestCase):

    def setUp(self):
        self.start_time = pd.to_datetime('1/1/2019')
        self.final_time = pd.to_datetime('1/2/2019')
    ...
    def test_set_setpoints(self):
        ...
        self.controller.set_setpoints(control = self.controller.control.display_data(),
