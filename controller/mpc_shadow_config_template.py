...
"data_manager_config": {
    ...
    "constraint": {
        "variables": {
            "Trtu_west_min":  {"type": "csv", "filename": "Shadow/Constraints_Forecast.csv", "column": "Trtu_min", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Trtu_west_max":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Trtu_max", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Trtu_east_min":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Trtu_min", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Trtu_east_max":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Trtu_max", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Tref_min":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Tref_min", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Tref_max":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Tref_max", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Tfre_min":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Tfre_min", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
            "Tfre_max":  {"type": "csv","filename": "Shadow/Constraints_Forecast.csv", "column": "Tfre_max", "tz":"America/Los_Angeles", "agg": "mean", "window": "1m"},
